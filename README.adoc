...
Se configuro la ruta de acceso para el chatbot en '/chatbot' y meotod GET.
...
Se instalo Flask usando `pip install -U flask-cors`
...
correspondiente. De esta manera queda disponible el codigo http en la siguiente URL: https://ppi-front.vercel.app/
