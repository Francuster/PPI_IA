...
Se creo una repositorio en https://vercel.com para generar un deploy automatizado, dandole acceso al servidor de github
donde se encuentra nuestra aplicación web. De esta manera queda disponible el servicio web en la siguiente URL: https://ppi-front.vercel.app/
