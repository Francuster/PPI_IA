...
----
Se vectorizan las preguntas, transformandolas en una secuencia de numeros que puede
usarl el algoritmo.
[source,python]
----
...
Se utiliza el modelo de NearestNeighbors de aprendisaje no supervisado y se lo
entrena con las preguntas vectorizadas.
[source,python]
----
